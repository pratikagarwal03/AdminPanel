    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="card card-widget widget-user">
              ...
              <div class="widget-user-header text-white" style="background-image:url('./images/user_cover.jpg')">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-12">
                          <input type="password" class="form-conrol" id="password" placeholder="Password" :class="{ 'is-invalid': form.errors.has('password') }">
          ...
          updatePhoto(e){
            ...
            if(file['size'] < 2111775){
              ...
              swal({
                type : 'error',
                title : 'Oops...',
                text : 'File size more than 2Mb!!! Please choose another file.',
              })
